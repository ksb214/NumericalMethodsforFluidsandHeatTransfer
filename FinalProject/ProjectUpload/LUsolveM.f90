    ...
    CONTAINS
      ...
      SUBROUTINE sgefat(a,lda,n,ipvt,info)
      IMPLICIT NONE
!
...
!
!
!     This subroutine's name was changed from 'sgefa' to 'sgefat'
!     because its name is same as routine in Cray system library.
!
!
!     sgefat factors a real matrix by gaussian elimination.
!
!     sgefat is usually called by sgeco, but it can be called
!     directly with a saving in time if  rcond  is not needed.
!     (time for sgeco) = (1 + 9/n)*(time for sgefat) .
!
!     on entry
!
!        a       real(lda, n)
...
!                     indicate that sgesl or sgedit will divide by zero
...
!
      ...
      ENDIF
      RETURN
      END SUBROUTINE sgefat


      SUBROUTINE sgeslt(a,lda,n,ipvt,b,job)
      IMPLICIT NONE
!
!     Declaration Generated by genImpDecs.pl 5/98
...
!
!
!     This subroutine's name was changed from 'sgesl' to 'sgeslt'
!     because its name is same as routine in Cray system library.
!
!
!     sgeslt solves the real system
!     a * x = b  or  trans(a) * x = b
!     using the factors computed by sgeco or sgefat.
!
!     on entry
!
!        a       real(lda, n)
!                the output from sgeco or sgefat.
!
!        lda     integer
!                the leading dimension of the array  a .
!
...
!
!        ipvt    integer(n)
!                the pivot vector from sgeco or sgefat.
!
!        b       real(n)
...
!           do 10 j = 1, p
!              call sgeslt(a,lda,n,ipvt,c(1,j),0)
!        10 continue
!
