...
!
!      REAL(sdk) :: timeSteps(7) =(/0.0001_sdk, 0.005_sdk, 0.01_sdk, &
!                   0.05_sdk, 0.1_sdk, 0.2_sdk, 0.4_sdk/)
      REAL(sdk) :: timeSteps(3) =(/0.001_sdk, 0.002_sdk, 0.004_sdk/) !, &
...
!
      ...
      f = 0.0_sdk            ! numerical method selector
                             ! = 1     Fully Implicit
                             ! = 0     Fully Explicit
                             ! = 0.5   Crank-Nicholson
      delt = 0.001_sdk      
...
!
      ...
      ELSE
         ...
         END DO
      END IF
      endTime = 0.8_sdk      !  End time for the transient
...
!
      ...
      DEALLOCATE ( b, tss)
      DEALLOCATE (t,tt,txs, tys, tx, ty, tLast)
